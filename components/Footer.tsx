    ...
    <div className="container">
      <div className="footer-content">
        ...
        <div className="section-footer-detail">
          <div className="section-footer-text">
            ...
            <div className="icons">
              ...
              <span>
                <svg fill="orange" width="30px" height="30px" viewBox="-2 -2 24 24" xmlns="http://www.w3.org/2000/svg"
              ...
              <span>
                <svg  className='ms-2 icon' fill="orange" width="30px" height="30px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                  data-name="Layer 1">
                  <path
              ...
              <span>
                <svg className="ms-2 icon" width="30px" height="30px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="white">
        ...
        <div className="footer-detail">
          ...
          <p className="ms-2 fw-bolder">Tel:+1-9099-37-7664</p>
        </div>
          <div className="d-flex">
            <p>
          ...
          <p className="ms-2">Email: elearnschool@gelearn.org</p>
          </div>
          <div className="d-flex">
            <p>
          ...
          <p className="ms-2">455 Oliver Street ,New York-US</p>
        </div>
        </div>
      </div>
      <p className="text-center text-warning mt-5 fw-bolder">&copy;Copyright , 2024 DASCOM Ltd</p>
